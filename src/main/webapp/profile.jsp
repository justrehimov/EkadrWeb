                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-12"><label class="labels">City</label>
                        <select name="city" class="form-select">
                            <option value="<%=company.getCityId().getId()%>" selected><%=company.getCityId().getCity()%></option>
                            <%for (City c:cityList){%>
                    ...
                    <div class="form-floating">
                        <textarea class="form-control" placeholder="About company" name="about" id="floatingTextarea2" style="height: 100px">
                            <%=company.getAboutCompany()%>
                        </textarea>
                    </div>
                </div>
