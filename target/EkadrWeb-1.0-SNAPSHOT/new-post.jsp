...
<div class="container">
    <form action="/new_post" method="post">
        ...
        <div class="form-btn">
            ...
            <input type="submit" onclick="setEditorsData(myeditor1,myeditor2,'information','requirements')" class="btn btn-primary" data-toggle="modal" data-target="#exampleModalCenter"
                   value="Add vacancy">
        </div>
    </form>
</div>
